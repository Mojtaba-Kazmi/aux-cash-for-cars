  ...
  return (
    <>
      ...
      <div className={styles.howItWorks}>
                ...
                <div className={styles.option}>
                    ...
                    <div className={styles.p}>
                        ...
                        <p>
                        By signing the title, the seller releases ownership of the car. Upon signing the title, the buyer takes it to the DMV, which issues a valid registration and title. It may be necessary to complete additional paperwork, such as a bill of sale or a transfer of ownership form, in some states.
                        </p>
                    </div>
                </div>
                <div className={styles.option}>
      ...
      <div className={styles.our_value_contianer}>
        ...
        <div className={styles.our_vation_massion}>
            ...
            <h2>OUR VISION</h2>
                <p>
                 To minimize the waste and making the good ways for recycling and reusing   
                 of them and supporting the community economy through that.
                </p>
            </div>
    ...
    <div className={styles.our_value_s_r}>
          <h2>OUR VALUES</h2>
           ...
           We consider and stand for the five main values that we have chosen for our 
           services that will guide the way we work on the projects: -
           </p>

           <p className={styles.values_text}>
                <span>Satisfaction and Compliance:</span>
                We try our best to get the Satisfaction of our customers, clients and our   
                employees, so we consider it as one of our values that we follow. 
           </p>

           <p className={styles.values_text}>
                <span>Our compatriot:</span>
                We value our employees, customers, clients, and suppliers. We are consigned 
                to support and contribute to the community.
           </p>
           ...
           <p className={styles.values_text}>
                ...
                We are continuously working and investing in technologies in order to bring 
                development and benefit our stakeholders and society.
           </p>

           <p className={styles.values_text}>
                <span>Sustainability:</span>
                We are consigned to provide and prepare the most sustainable recycling 
      ...
      <div className={styles.export_s_l}>
        ...
        <p>
            <span>
             We export high-quality metals both ferrous and non-ferrous to the UAE.
             We have tried to prepare a range of container loaders and material handlers 
             that meet the demands and needs of our buyers.  
            </span>
            We have a good partnership and cooperation with each other in order to save 
            environment and improve and support the econometry of both countries. 
        </p>
      
        <p>
        Due to the large amount of demand for the steel inside our own country, we also 
        supply a considerable quality of Fragmented steel to the local or internal markets. 
        We provide and prepare substantial amount of Frag steel across Australian Steel 
        Mills.
        </p>
      ...
      <div className={styles.recyclers_contianer}>
        ...
        <div className={styles.recyclers_s_r}>
              <p>
               SYDNEY PREMIER AUTO WRECKER
              </p>
              <h2>
              (AUX Cash for Car Sydney) is your Professional and Friendly Scrap Metal   
               Recyclers
              </h2>
              <p>
                  <span>
