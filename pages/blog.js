  ...
  return (
    <>
      <Head>
        ...
        <meta name="keywords" content="cash for cars sydney, Car Removal Sydney, Junk Car Removal Near Me, payment, fast pick up, Car's Condition, laws"></meta>
        ...
        <div className={styles.blog}>
          ...
          <div className={styles.blogContainer}>
                ...
                <section className={styles.lastPage}>
                  ...
                  <section className={styles.post}>
                    <Image
                      ...
                      <p className={styles.text}>
                          There are many reasons why you might want to get rid of an old car.   
                          It may be that it's reached the end of its life and is starting to 
                          break down, or it could be that it's been
                  ...
                  <section className={styles.post}>
                    <Image
                      ...
                      <p className={styles.text}>
                        Regarding buying a car, the condition of the vehicle is one of the most 
                        important factors that can affect the price. Whether you are looking to 
                        buy a new or
                  ...
                  <section className={styles.post}>
                    <Image
                      ...
                      <p className={styles.text}>
                          ...
                          govern the process. This will help ensure
                  ...
                  <section className={styles.post}>
                    <Image
                      ...
                      However, if you're not careful, you could end up getting scammed. In this 
                      article, we'll go over how to receive
                ...
                <section className={styles.pages}>
                  ...
                  <section className={styles.post}>
                    <Image
                      ...
                      <p className={styles.text}>
                        ...
                        driving habits of the owner. In general, however, most cars
                  ...
                  <section className={styles.post}>
                    <Image
                      ...
                      <p className={styles.text}>
                        ...
                        something new. But, you're probably wondering, how can I sell my
                  ...
                  <section className={styles.post}>
                    <Image
                      ...
                      <p className={styles.text}>
                        ...
                        make and model to its age and mileage.
                  ...
                  <section className={styles.post}>
                    <Image
                      ...
                      batteries and lubricating oils in old cars pose a health risk. Used 
                  ...
                  <section className={styles.post}>
                    <Image
                      ...
                      <p className={styles.text}>
                      Want to get rid of your current old vehicle? Wondering who buys used cars  
                      in any condition, or how you can exchange your vehicle for cash?
                      You can sell your broken down car to us for good cash.
            ...
            <div className={styles.buttons}>
              ...
              <p className={styles.nextBtn}onClick = {sliderLeft}><MdNavigateNext /></p>
            </div>
          </div>
