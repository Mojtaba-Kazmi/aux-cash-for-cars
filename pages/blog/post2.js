  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="lead-acid batteries and lubricating oils in old cars pose a health risk. Used vehicles 
        ...
        <meta
          name="keywords"
          content="shaking and Noises in car, expensive repairs, replacement, Excessive Rust in cars"
        ></meta>
        ...
        <meta
          property="og:title"
          content="Cars to Get Rid of: Signs you need a replacement one"
        />
        <meta
        ...
        <div className={styles.blogSL}>
          ...
          <div>
            <p>
              ...
              risk. Used vehicles may also have damaged parts that are dangerous
              for people. As a car ages, its repair bills tend to increase. read
              on to learn 3 signs it time to replace it if you do not know
              whether or not to get rid of your car.
            </p>
            <h2>1. Noises, Shaking, and Other Serious Symptoms</h2>
            <p>
              Vibration and noises are one of the most common and most
              bothersome problems when owning a car for a long time. Most often,
              these shaking and noise problems are caused by problems with the
              engine, axle, power steering, and motor mounts. A simple fix, such
              as rotating or balancing tires, could suffice. Unfortunately, it
              could also indicate some more serious problems, such as a steering
              or suspension malfunction.
            </p>
            <h2>2. Expensive Repairs </h2>
            <p>
              If the cost of repairs exceeds the value of your car, it is a good
              indication that you should sell it. You can get your car running
              again, but you will not get your money back if you sell it. If
              your vehicle is older or in poor condition, you can expect more
              repairs in the near future.
            </p>
            <h2>3. Excessive Rust</h2>
            <p>
              In spite of the fact that rust may seem like no big deal, it can
              cause serious issues if left unattended, including fuel leaks,
              brake failures, or even rusted appearance.
            </p>
