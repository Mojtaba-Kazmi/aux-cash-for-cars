    ...
    <>
      ...
      <div className={styles.About_us_contianer}>
        <div className={styles.about_s_l}>
          ...
          <p>
              <span>
              (<Link href={'/'} className={Sharing.link}>AUX Cash for Car Sydney</Link>) has been pioneering the metal resource recycling 
              industry in Sydney region, Australia since 2010 that mostly has 
              been active in car removal industry.
              </span>
          ...
          <p>
          At (<Link href={'/'} className={Sharing.link}>AUX Cash for Car Sydney</Link>) we try to start by understanding our client’s needs. 
          Once we informed then we work out the best time and payment we can offer. Our goal 
          at (<Link href={'/'} className={Sharing.link}>AUX Cash for Car Sydney</Link>) is to offer our clients stress-free, good and friendly 
          ...
          (<Link href={'/'} className={Sharing.link}>AUX Cash for Car Sydney</Link>) give you up to $9999 for your old, junk, damaged or 
          ...
          <p>
            ...
            come in the right place, because (<Link href={'/'} className={Sharing.link}>AUX Cash for Car Sydney</Link>) offers you up to $9999 
            for your old car. 
        </p>
        <p>
