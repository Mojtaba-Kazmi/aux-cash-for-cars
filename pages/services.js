    ...
    <div className={styles.services_container}>
        ...
        <div className={styles.servises_item}>
          ...
          <p>
            ...
            with (<Link className={Sharing.link} href={'/'}>AUX Cash for Car Sydney</Link>) and earn a good amount of money for your car. 
          </p>
        </div>
        ...
        <div className={styles.servises_item}>
          ...
          <p>
            With (<Link className={Sharing.link} href={'/'}>AUX Cash for Car Sydney</Link>) you can even change your waste to cash. We have 
