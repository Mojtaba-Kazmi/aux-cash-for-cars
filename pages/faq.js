    ...
    <>
      <Head>
        <title>FAQs - Aux Cash For Cars</title>
          ...
          <meta name="keywords" content="cash for cars sydney, Car Removal Sydney,sell my old car, why a cash for car, brands, fast pick-up, price of damaged cars, car title"></meta>
        ...
        <div className={styles.faqL}>
          ...
          <div className={styles.questionContainer}>
            <Link href={"/faq/question1"}>
              <h2 className={styles.question}>Why should I choose AUX Cash for Car?</h2>
            </Link>
          ...
          <div className={styles.questionContainer}>
            <Link href={"/faq/question2"}>
              <h2 className={styles.question}>What kind of cars does AUX Cash for Car buy?</h2>
            </Link>
            <p className={styles.answer}>
              AUX Cash for Car will purchase damaged vehicles of any type, including vehicles 
              with physical, electrical or mechanical damage as well as vehicles with high...
          ...
          <div className={styles.questionContainer}>
            <Link href={"/faq/question3"}>
              <h2 className={styles.question}>How fast do AUX Cash for Car pick-up my car?</h2>
            </Link>
            <p className={styles.answer}>
            ...
            after receiving your vehicle's information and after you accept...
          ...
          <div className={styles.questionContainer}>
            <Link href={"/faq/question4"}>
              <h2 className={styles.question}>How much I should expect for my car?</h2>
            </Link>
            <p className={styles.answer}>
              ...
              much you'll get there unless we...
          ...
          <div className={styles.questionContainer}>
            <Link href={"/faq/question5"}>
              <h2 className={styles.question}>Will you buy my car if it doesn’t have title?</h2>
            </Link>
            <p className={styles.answer}>
