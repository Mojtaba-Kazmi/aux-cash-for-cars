    ...
    <>
      <Head>
        <title>Contact Us - Aux Cash For Cars</title>
          <meta name="description" content={`Fill out the form  and one of our Car Removal specialists will give you a call. Alternatively you may call us free on ${<a href='tel:0469798540' title='Click here to make a call'>0469798540</a>}`} />
          <meta name="keywords" content="cash for cars sydney, Car Removal Sydney,sell my old car, contact"></meta>
        ...
        <div className={styles.section2}>
          <div className={styles.section2Left}>
            <div>
              ...
              <p>We offer free car removal all over the greater Sydney area. Turn your car removal needs into 
                  cash for your car all over Sydney. We’ll organize car removal for you today – and pay cash!
              </p>
            </div>
          ...
          <div className={styles.section2Right}>
            <form action='https://formspree.io/f/mknaoepd' method="POST" >
              ...
              <div className={styles.names}>
                <div>
                  <label htmlFor='#companyName' name='Campany Name' >Company Name</label>
                  <br />
                  <input type="text" id='companyName' name='Campany Name' />
                </div>
                <div>
                  <label htmlFor='#contactName' name='Contact Name'>Contact Name *</label>
                  <br />
              ...
              <div>
                  <label htmlFor='#phoneNum' name = 'Phone'>Phone Number</label>
                  <br />
              ...
              <label htmlFor='#massage' name = 'Massage'>Massage *</label>
                  <br />
