            ...
            <div className={styles.slide_wraper} style = {{marginLeft: nextSlide}}>
                <div className={styles.slide_item}>
                    <div className={styles.slide_text}>
                        <div className={nextText ? styles.textOnClick1: styles.textOnClick2}>
                            <h2 className={styles.title}>AUX Cash for Car</h2>
                            <p className={styles.slide_p}>One of the largest Scrap AUX Cash for Car In Sydney.</p>
                        </div>
                ...
                <div className={styles.slide_item}>
                    <div className={styles.slide_text}>
                        <div className={nextText ? styles.textOnClick1: styles.textOnClick2}>
                            <h2 className={styles.title}>AUX Cash for Car</h2>
                            <p className={styles.slide_p}>One of the largest ScrapAUX AUX CASH FOR CAR In Sydney.</p>
                        </div>
                        <div className={styles.d1}></div>
                    </div>
